...
Source0  : https://files.pythonhosted.org/packages/57/88/f8ce5cf43226357ebf8e2a5b6ea39c7747947620f5d9de34e883c0705a10/responses-0.13.2.tar.gz
...
%prep
%setup -q -n responses-0.13.2
cd %{_builddir}/responses-0.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617057547
...
cp %{_builddir}/responses-0.13.2/LICENSE %{buildroot}/usr/share/package-licenses/responses/cef33b64c628a8301c7f0a1d2360484b9fe5bed1
