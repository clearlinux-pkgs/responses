...
Source0  : https://files.pythonhosted.org/packages/60/1e/9fccce8f669a60f58072535ef2e7bb6ceb68cc894b2eb9374be3c7a29a7e/responses-0.10.9.tar.gz
...
%prep
%setup -q -n responses-0.10.9
cd %{_builddir}/responses-0.10.9
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583219807
...
cp %{_builddir}/responses-0.10.9/LICENSE %{buildroot}/usr/share/package-licenses/responses/cef33b64c628a8301c7f0a1d2360484b9fe5bed1
