...
Version  : 0.10.16
Release  : 24
URL      : https://files.pythonhosted.org/packages/34/d7/7dd8114013564039d64fc53b894711881a19a53e438d8a1a1559f54cbd2d/responses-0.10.16.tar.gz
Source0  : https://files.pythonhosted.org/packages/34/d7/7dd8114013564039d64fc53b894711881a19a53e438d8a1a1559f54cbd2d/responses-0.10.16.tar.gz
...
%prep
%setup -q -n responses-0.10.16
cd %{_builddir}/responses-0.10.16
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597256704
...
cp %{_builddir}/responses-0.10.16/LICENSE %{buildroot}/usr/share/package-licenses/responses/cef33b64c628a8301c7f0a1d2360484b9fe5bed1
