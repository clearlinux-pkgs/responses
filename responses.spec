...
Source0  : https://files.pythonhosted.org/packages/46/5d/6a1253e026fcacaddebcac255f46b6e714f78901b5af59282ec275445513/responses-0.10.12.tar.gz
...
%prep
%setup -q -n responses-0.10.12
cd %{_builddir}/responses-0.10.12
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584381109
...
cp %{_builddir}/responses-0.10.12/LICENSE %{buildroot}/usr/share/package-licenses/responses/cef33b64c628a8301c7f0a1d2360484b9fe5bed1
