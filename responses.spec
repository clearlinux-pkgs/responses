...
Source0  : https://files.pythonhosted.org/packages/9c/45/32f8d8c0c8f1f3843419a36aee0815bad040ac0029cfe96bb894894f042d/responses-0.10.14.tar.gz
...
%prep
%setup -q -n responses-0.10.14
cd %{_builddir}/responses-0.10.14
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587399925
...
cp %{_builddir}/responses-0.10.14/LICENSE %{buildroot}/usr/share/package-licenses/responses/cef33b64c628a8301c7f0a1d2360484b9fe5bed1
