...
Source0  : https://files.pythonhosted.org/packages/35/fc/d58c1464a38b9455a4bedb36d5e345b11b5158c3af10efac7e6df4bf0551/responses-0.13.4.tar.gz
...
%prep
%setup -q -n responses-0.13.4
cd %{_builddir}/responses-0.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628538377
...
cp %{_builddir}/responses-0.13.4/LICENSE %{buildroot}/usr/share/package-licenses/responses/cef33b64c628a8301c7f0a1d2360484b9fe5bed1
